...
X0= [l2*cos(q1 + q2) + l1*cos(q1) l2*sin(q1 + q2) + l1*sin(q1) q1 + q2 + q3]'
Xf= [0.5 0.5 0]';
t0 = 0;
dt = 0.01;
tf = 4;
...
J = [- l2*sin(q(1,i-1) + q(2,i-1))-l1*sin(q(1,i-1)), -l2*sin(q(1,i-1) + q(2,i-1)); 
    l2*cos(q(1,i-1) + q(2,i-1)) + l1*cos(q(1,i-1)), l2*cos(q(1,i-1) + q(2,i-1))];
qdot(:,i) = J\(Xdot(1:2 , i));
q(:,i) = q(:,i-1) + qdot(:,i)*dt;
end
